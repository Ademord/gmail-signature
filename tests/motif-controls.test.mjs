...
test('40-field sessions preserve independent side and flowing settings, importing them only with Design',()=>{
  ...
  const old=Object.fromEntries(Object.entries(incoming.draft).filter(([key])=>!keys.includes(key)&&!['cardGap','cardFormat'].includes(key)));assert.equal(Object.keys(old).length,35);

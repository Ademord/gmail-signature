...
test('selective import uses the independently expected information/design boundary and preserves every unchecked field', () => {
  ...
  const incoming = session.parse(session.serialize({draft:{...core.defaults,nameLine1:'Incoming',nameLine2:'Person',title:'Artist',subtitle:'ART',tags:'DRAW · BUILD',
    ...
    nameLayout:'wrap',nameFontSize:18,titleFontSize:10,subtitleFontSize:10,contactFontSize:11,footerFontSize:9,lineSpacing:90,textSpacing:80,contactSpacing:90,sectionSpacing:80,contentPadding:20,sidePadding:8,singleArrangement:'rows',contactLayout:'stacked',contactFont:'sans',footerVisible:'hide',

...
- Before synthetic live testing, the upgraded hosted export preserved all 23 original fields, the saved theme and UI settings exactly; it also matched the original private backup. Restore and verify that private session after the final versioned deployment. No personal values enter public release evidence.
